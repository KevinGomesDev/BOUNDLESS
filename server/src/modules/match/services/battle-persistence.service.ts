...
import type { ArenaBattleState } from "../../arena/colyseus/schemas";
...
// ============================================
// Arena Battle Persistence
// ============================================

/**
 * Salva o estado de uma batalha de Arena no banco de dados
 */
export async function saveArenaBattle(
  battleId: string,
  ...
  state.units.forEach((unit) => {
    ...
    unitsData.push({
      unitId: null, // Arena units são temporários
